...
INSERT INTO scrap(user_id, category_id, title, url, memo, is_favorite, is_public, created_at) VALUES (1, 0, '전체조회', 'https://youtube.com/...', '전체조회', true, true, CURRENT_TIMESTAMP());
INSERT INTO scrap(user_id, category_id, title, url, memo, is_favorite, is_public, created_at) VALUES (2, 0, '전체조회2', 'https://youtube.com/...', '전체조회2', true, false, CURRENT_TIMESTAMP());
...
INSERT INTO scrap(user_id, category_id, title, url, memo, is_favorite, is_public, created_at) VALUES (2, 3, 'LCK 명장면', 'https://youtube.com/...', '개잘해..', false, true, CURRENT_TIMESTAMP());
INSERT INTO scrap(user_id, category_id, title, url, memo, is_favorite, is_public, created_at) VALUES (2, 4, '동글이', 'https://youtube.com/...', '진심으로귀여워요', false, true, CURRENT_TIMESTAMP());
INSERT INTO scrap(user_id, category_id, title, url, memo, is_favorite, is_public, created_at) VALUES (1, 2, '우유', 'https://youtube.com/...', '사모예드는 눈으로 기른다', false, true, CURRENT_TIMESTAMP());
...
INSERT INTO scrap(user_id, category_id, title, url, memo, is_favorite, is_public, created_at) VALUES (2, 3, '어몽어스', 'https://youtube.com/...', '같이 할 사람이 없네...', true, true, CURRENT_TIMESTAMP());
